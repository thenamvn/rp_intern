...
\begin{figure}[H]
    \centering
    % Thay thế tên file ảnh tương ứng trong thư mục figures/
    \includegraphics[width=0.45\textwidth]{figures/app_dashboard.jpg} 
    \hfill
    \includegraphics[width=0.45\textwidth]{figures/app_statistics.jpg}
    \caption{Mobile Application Interface: Dashboard (Left) and Statistics Screen (Right)}
    \label{fig:mobile_ui}
\end{figure}
